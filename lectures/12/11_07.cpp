...
class Stack {
	...
	public:
		class ExcEmpty { 	//exception class for empty Stack
		};
		class ExcFull {		//exception class for full Stack
		};
	Stack(){ 
		top = -1; 
	}
...
//		s1.push(44);		// Stack full !!
	...
	catch (Stack::ExcEmpty){
		cout << endl << "Exception: Stuck empty." << endl;
	}
	catch (Stack::ExcFull){
		cout << endl << "Exception: Stuck full." << endl;
	}
